...
public class iDBManager2000 {
  ...
  public iDBManager2000() {
	...
	*/
    ...
    ConnectionString="jdbc:oracle:thin:@10.230.31.61:1521:orcl";
    UserName="swjsp";
    PassWord="swjsp";

    //For MySQL Driver
   // ClassString="org.gjt.mm.mysql.Driver";
    //ConnectionString="jdbc:mysql://192.168.1.144:3306/pdfdemo?user=riserc8&password=111111&useUnicode=true&characterEncoding=gbk";
    //UserName="riserc8";
    //PassWord="111111";
