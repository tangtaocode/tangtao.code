...
import net.risesoft.approve.service.FileBoxActionService;
...
@Service(value="fileBoxActionServiceImpl")
public class FileBoxActionServiceImpl implements FileBoxActionService {
	...
	protected Logger log = LoggerFactory.getLogger(FileBoxActionServiceImpl.class);
...
/*			Process process = null;
			...
			for (int i = 0; i < fileItems.size(); i++) {
				...
				if (fi.isFormField()) {
					...
					fileItem.setCurrentUser(risenetInfo.getEmployeeGuid());
