...
/**
 * TBujiaoshouliId entity.
 * 
 * @author MyEclipse Persistence Tools
 */


public class TBujiaoshouliUnits  implements Serializable {
    ...
    /** default constructor */
    public TBujiaoshouliUnits() {
    }

    
    /** full constructor */
    public TBujiaoshouliUnits(String ywlsh, Long sjbbh) {
        this.ywlsh = ywlsh;
        this.sjbbh = sjbbh;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TBujiaoshouliUnits) ) return false;
		 TBujiaoshouliUnits castOther = ( TBujiaoshouliUnits ) other; 
...
public String toString() {
	return "TBujiaoshouliUnits [ywlsh=" + ywlsh + ", sjbbh=" + sjbbh + "]";
}   
