...
/**
 * TShenbanUnits entity.
 * 
 * @author MyEclipse Persistence Tools
 */


public class TShenbanUnits  implements Serializable {
	...
	// Fields
     ...
     private Long sjbbh;		//"SJBBH" NUMBER(4) DEFAULT 1  NOT NULL ,	数据的版本号，默认为1


    // Constructors

    /** default constructor */
    public TShenbanUnits() {
    }

    
    /** full constructor */
    public TShenbanUnits(String ywlsh, Long sjbbh) {
        this.ywlsh = ywlsh;
        this.sjbbh = sjbbh;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TShenbanUnits) ) return false;
		 TShenbanUnits castOther = ( TShenbanUnits ) other; 
...
public String toString() {
	return "TShenbanUnits [ywlsh=" + ywlsh + ", sjbbh=" + sjbbh + "]";
}   
