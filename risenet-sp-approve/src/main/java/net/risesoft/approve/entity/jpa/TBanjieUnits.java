...
public class TBanjieUnits  implements Serializable {
    ...
    /** full constructor */
    public TBanjieUnits(String ywlsh, Long sjbbh) {
        this.ywlsh = ywlsh;
        this.sjbbh = sjbbh;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TBanjieUnits) ) return false;
		 TBanjieUnits castOther = ( TBanjieUnits ) other; 
