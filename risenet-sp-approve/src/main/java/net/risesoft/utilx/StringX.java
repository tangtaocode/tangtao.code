...
public class StringX {
	...
	/*public static void main(String[] args){
		System.out.println(formatDigitalNumber("0.0000",3));
	}*/
	/*
	 * 季度转换
	 */
	public static String getNumQuart(String quart){
		if("第一季度".equals(quart)){
			return "1";
		}else if("第二季度".equals(quart)){
			return "2";
		}else if("第三季度".equals(quart)){
			return "3";
		}else if("第四季度".equals(quart)){
			return "4";
		}else{
			return quart;
		}
