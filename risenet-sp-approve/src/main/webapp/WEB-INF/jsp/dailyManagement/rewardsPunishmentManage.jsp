...
<form id="form" action=""   method="post"><input type="hidden" id="sg" value="${score.scoreguid }"/>
	<table class="tableStyle"  formMode="transparent" border="0">
		...
		<tr>
			<td>奖励</td>
			<td><input type="text" id="rewards" value="${score.rewards }" inputMode="numberOnly" /></td>
			<td>惩罚</td>
			<td><input type="text" id="punishment" value="${score.punishment }"  inputMode="numberOnly" /></td>
		</tr>
		
		<tr>
			<td>投诉</td>
			<td><input type="text" id="complaints" value="${score.complaints }"  inputMode="numberOnly" /></td>
			<td>表扬</td>
			<td><input type="text" id="praise"  value="${score.praise }" inputMode="numberOnly" /></td>
		</tr>
		<tr>
			<td colspan="4"><button type="button"  onclick="savejcjl();">保存</button></td>
		</tr>
