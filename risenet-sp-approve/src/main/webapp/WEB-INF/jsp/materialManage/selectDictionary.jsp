...
function selected(rowidx){
	...
	parent.document.getElementById("materialguid").value=row.GUID;
	parent.document.getElementById("material_name").value=row.MATERIAL_NAME;
	parent.document.getElementById("material_code").value=row.MATERIAL_CODE;
	parent.document.getElementById("unit").value=row.UNIT;
