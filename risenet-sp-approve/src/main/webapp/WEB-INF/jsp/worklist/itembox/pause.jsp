...
<script type="text/javascript">
		...
		function initComplete(){
			size();
			 g = $("#maingrid").quiGrid({
		       columns: [ 
			                { display: '业务流水号', name: 'declaresn', align: 'center', width: "13%"},
			                { display: '办理状态', name: 'state', align: 'center', width: "12%"},
		         ...
		         url : '${ctx}/sp/worklist/pause/list',rownumbers:true,pageSize:30,percentWidthMode:true,usePager:true,
		...
		function process(taskId,documentTitle) {
			var url = '${ctx}/sp/document/edit?itembox=pause&taskId=' + taskId;
...
<body>
	<div class="box2" panelTitle="查询" id="searchPanel">
		<form action="${ctx}/sp/worklist/pause/list" id="queryForm" method="post" align="center">
		<table>
			<tr>
				<td>文件标题：</td>
				<td><input type="text" name="pauseDocumentTitle" id="pauseDocumentTitle" 
