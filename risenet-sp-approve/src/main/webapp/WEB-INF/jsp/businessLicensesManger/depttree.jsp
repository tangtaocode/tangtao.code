...
var setting1 = {
	...
	function initComplete() {
		...
		//远程得到树
		$.post("${ctx}/bureaCode/rc8depttreelist", {}, function(result) {
	...
	function getSelectValue(){
	    ...
	    for(var i = 0; i < checkedNodes.length;i++){	
	    	...
	    	allid = checkedNodes[0].id;
	    	allname = checkedNodes[0].name
	    }

	    $.post("${ctx}/bureaCode/savedeptinfo?ID=${ID}",{"ALLID":allid,"ALLNAME":allname},function(result){
	    		alert(result.msg);
	    		parent.g.loadData();
	    		parent.Dialog.close();
		       },"json"); 
...
<body>
  <div class = "box1" >
	<div id="layout1">
		...
		<div style="" panelTitle="证照列表">
			<div class="layout_content" panelWidth="520">
				<div>
					<legend>请选择rc8部门ID</legend>
