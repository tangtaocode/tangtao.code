...
$(document).ready(function() {
	$('input[name=sequence]').css('color','red');
...
<table border="0px">
	...
	<tr>
		<td>
			<input type="text" id="sequence" name="sequence" value="${sequence}" style="text-align:center;width:190px;border-top:none;border-left:none;border-right:none;border-bottom: 1px solid black;">
		</td>
	</tr>
	<tr>
		<td align="center">
			<input type="button" id="submit1" name="submit1"  value="确定">&nbsp;&nbsp;&nbsp;
			<input type="button" id="cancel1" name="cancel1"  value="取消" onclick="opener.activeButton();window.close()" type="button">
		</td>
	</tr>
</table>
</div>
