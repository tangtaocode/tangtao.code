		...
		<div align="center">
				<table width="643" border="1" cellpadding="4" cellspacing="0"
					...
					<tr>
						...
						<input  type = "hidden" name="guids"  id="guids" value="${guids}" />
						<input  type = "hidden" name="opinionType"  id="opinionType" value="2" />
							...
							<table border="0" cellspacing="0" cellpadding="2"
								...
								<tr>
									<td align="left">&nbsp;
										...
										<input type="text" name="userName" value="${userName}" id="Comment_Person" style="width: 50px; color: red" disabled="disabled">
										<font id="deptNameFontId">部门：</font>
										<input type="text" name="deptName" value="${deptName}" id="deptName" style="width: 100px; color: red" disabled="disabled">
									</td>
