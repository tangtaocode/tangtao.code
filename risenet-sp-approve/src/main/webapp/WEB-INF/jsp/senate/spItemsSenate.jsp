...
<script type="text/javascript">
		...
		function initComplete(){
			 g = $("#maingrid").quiGrid({
		       columns: [ 
						...
						{ display: '事项性质', name: 'APPROVEITEMTYPE', align: 'center', width: "15%"},
						{ display: '事项名称', name: 'APPROVEITEMNAME', align: 'center', width: "25%"},
						{ display: '收件处理', name: '',align: 'center', width: "20%",
							render: function(rowdata, rowindex, value, column){
			                	return '<input type="button" onclick="openSenateWin(\'' + rowdata.APPROVEITEMGUID + '\');" value="服务评价"/>'
			                }
		        ...
		        url:"${ctx}/senateManage/spItemsSenateList",rownumbers:true,percentWidthMode:true,checkbox:false,
    ...
    function openSenateWin(approveItemId){
    	Dialog.open({URL:"${ctx}/senateManage/startSenate?approveItemId="+approveItemId,Title:"审批服务评价",Width:450,Height:150});
    }
</script>	
</body>
</html>
