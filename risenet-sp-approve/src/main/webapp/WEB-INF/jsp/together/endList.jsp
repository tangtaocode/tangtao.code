		...
		function initComplete(){
			 g = $("#maingrid").quiGrid({
		       columns: [ 
			                ...
			                { display: '项目名称', name: 'XIANGMUMINGCHENG', align: 'center', width: "15%"},
			                { display: '申请人', name: 'DECLARERPERSON', align: 'center', width: "10%", isSort:false},
		        ...
		        url:"${ctx}/togetherWindow/endList",rownumbers:true,pageSize:20,percentWidthMode:true,usePager:true,
		 ...
		 function onReceive(instanceGuid,name,guid){
			 window.parent.openTab(name,"${ctx}/togetherWindow/newReceive?guid="+guid+"&method=end&instanceGuid="+instanceGuid);
		 }
...
<body>
	<div class="box2" panelTitle="查询" id="searchPanel">
		<form action="${ctx}//togetherWindow/endList" id="queryForm" method="post" align="center">
		<table>
			<tr>
				<td>事项名称：</td>
