...
<script type="text/javascript">
		...
		function initComplete(){
			 g = $("#maingrid").quiGrid({
		       columns: [ 
			                ...
			                { display: '科室名称', name: 'BUREAUNAME', align: 'center', width: "15%",showTitle:true},
		        ...
		        url:"${ctx}/bureau/wbjList",usePager:true,rownumbers:true,percentWidthMode:true,checkbox:true,
		       	pageSize:20,
		...
		function eformConfig(){
			...
			if(len<1){
				...
				var approveitemguid=row[0].APPROVEITEMGUID;
				Dialog.open({URL:"${ctx}/bureau/eformbound?approveitemguid="+approveitemguid,title:"事项与表单绑定",width:600,height:200})
