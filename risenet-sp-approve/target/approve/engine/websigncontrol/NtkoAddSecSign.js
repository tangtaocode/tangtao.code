//注意:这是内部需要使用的函数，除
//ocxElement.codebase = "ntkoWebSign.cab#version=4,0,0,0";
...
function NtkoReserved_AddSecSignOcx(ControlID,ocxLeft,ocxTop)
{
	...
	try
	{
		...
		ocxElement.codebase = "websigncontrol/ntkoWebSign.cab#version=4,0,0,1";
...
{
	if(secSignObj != null && secSignObj.UserData == UserData)
    {
	    secSignObj = null;
	}
}
