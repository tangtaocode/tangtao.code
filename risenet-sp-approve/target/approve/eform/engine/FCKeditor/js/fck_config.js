...
config.ToolbarSets["Default"] = [
	['Cut','Copy','Paste','-','SelectAll','RemoveFormat','-','Link','RemoveLink','-','Image','Rule','-','About'] ,
	['FontStyle','-','Bold','Italic','Underline','-','InsertOrderedList','InsertUnorderedList','-','Undo','Redo']
] ;

config.ToolbarSets["Default_1"] = [
...
config.ImageBrowserURL = config.BaseUrl + config.BasePath + "filemanager/browse/sample_jsp/browse.jsp?type=img" ;
...
//徐宝新修改
//config.ImageUploadURL =  config.BasePath + "filemanager/upload/jsp/upload.jsp?type=img" ;
config.ImageUploadURL = config.BaseUrl + config.BasePath + "filemanager/upload/jsp/upload.jsp?type=img" ;
// Image upload window sizes
config.ImageUploadWindowWidth	= 400 ;
config.ImageUploadWindowHeight	= 300 ;
...
config.LinkBrowserURL = config.BaseUrl + config.BasePath + "filemanager/browse/sample_jsp/browse.jsp?type=doc" ;
// Link browsing window sizes
config.LinkBrowserWindowWidth	= 400 ;
config.LinkBrowserWindowHeight	= 250 ;

//##
//## Link Upload ,????????type=doc
//##
config.LinkUpload = true ;
//徐宝新修改
//config.LinkUploadURL = config.BasePath + "filemanager/upload/jsp/upload.jsp?type=doc" ;
config.LinkUploadURL = config.BaseUrl+config.BasePath + "filemanager/upload/jsp/upload.jsp?type=doc" ;
