...
<script type="text/javascript">
		...
		function initComplete(){
			 g = $("#maingrid").quiGrid({
		       columns: [
		        ...
		        url:"${ctx}/senateManage/detailList?classify=district&fromPage=${param.fromPage}&employeeid=${param.employeeid}&itemguid=${param.itemguid}&bureauGuid=${param.bureauGuid}&type=${param.type}&resultType=${personid}districtDptDetail",rownumbers:true,percentWidthMode:true,checkbox:false,
  ...
  //导出为Excel
	function exportPageData(){
	  	window.location.href="${ctx}/senateManage/exportData?filename=评价详细统计表&resultType="+personidPage;
		out.clear();
