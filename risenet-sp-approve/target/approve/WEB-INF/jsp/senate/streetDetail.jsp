...
var personidPage="${personid}streetDetail";	
</script>
</head>
<body>
		...
		function initComplete(){
			 g = $("#maingrid").quiGrid({
		       columns: [
		        ...
		        url:"${ctx}/senateManage/detailList?classify=street&employeeid=${param.employeeid}&itemguid=${param.itemguid}&bureauGuid=${param.bureauGuid}&type=${param.type}&resultType="+personidPage,rownumbers:true,percentWidthMode:true,checkbox:false,
