...
var personidPage="${personid}communityDetail";	
</script>
</head>
<body>
...
<script type="text/javascript">
		...
		function initComplete(){
			 g = $("#maingrid").quiGrid({
		       columns: [
		        ...
		        url:"${ctx}/senateManage/detailList?classify=community&employeeid=${param.employeeid}&itemguid=${param.itemguid}&bureauGuid=${param.bureauGuid}&type=${param.type}&resultType="+personidPage,rownumbers:true,percentWidthMode:true,checkbox:false,
  ...
  //导出为Excel
	function exportPageData(){
	  	window.location.href="${ctx}/senateManage/exportData?filename=价详细统计表&resultType="+personidPage;
		out.clear();
