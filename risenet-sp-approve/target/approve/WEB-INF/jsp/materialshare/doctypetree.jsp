...
var setting1 = {
	...
	function initComplete() {
		...
		//远程得到树
		$.post("${ctx}/relationmaterial/doctypetreelist", {}, function(result) {
	...
	function getSelectValue(){
	    ...
	    $.post("${ctx}/relationmaterial/savedoctype?ID=${ID}",{"ALLID":allid,"ALLNAME":allname},function(result){
	    		alert(result.msg);
	    		parent.g.loadData();
	    		parent.Dialog.close();
		       },"json"); 
