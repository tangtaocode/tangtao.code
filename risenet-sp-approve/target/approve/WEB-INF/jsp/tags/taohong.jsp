		...
		$.getJSON("${ctx}/ntko/list", 
			...
			var trtemp="";
				$.each(data,function(i,item){
						if(item.hasDocumentTemplate==0){
							$(".ui-layout-content").prepend(divtemp);
						}else{
							trtemp=trtemp+"<tr><td class=\"li2_td_left\" style=\"width: 140px;\"><input type=\"radio\" name=\"taohong\" onclick=\"setValue(this)\" value=\""+item.template_guid+"|"+item.template_caption+"|"+item.template_type+" \"> "+item.template_caption+"  </td></tr>"
						}
				});
