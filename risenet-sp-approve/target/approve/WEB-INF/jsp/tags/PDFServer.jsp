...
<%@ page import="net.risesoft.fileflow.servlet.iDBManager2000"%>
<%!public class iWebOffice {
		...
		private net.risesoft.fileflow.servlet.iDBManager2000 DbaObj;
		...
		public void ExecuteRun(HttpServletRequest request, HttpServletResponse response) {
			DbaObj = new net.risesoft.fileflow.servlet.iDBManager2000(); //创建数据库对象
