...
<html>
<head>
<title>广东省网上办事大厅深圳市龙岗区住房与建设局-投资审批</title>
<meta name="keywords" content="深圳市龙岗区住房与建设局网上办事大厅-投资审批,深圳市龙岗区住房与建设局办事大厅投资审批,投资审批,深圳市住房与建设局投资审批"></meta>
<meta name="description" content="广东省网上办事大厅深圳市龙岗区住房与建设局-投资审批首页"></meta>
...
<script src="/js/businessJS/investment.js" type="text/javascript"></script>
<script type="text/javascript">
	$(document).ready(function(){
		changeTzType('enterprise');
	})
</script>
</head>
...
<div class="GovOpenIndex ">
	...
	<table border="0" cellpadding="0" cellspacing="20px" style="width: 100%;">
		<tr>
			<td align="left">
				<span style="font-size: 18pt;">社会投资项目备案管理</span>
			</td>
			<td align="right">
				<table id="titleTabTable" border="0" cellpadding="0" cellspacing="0" style="width: 400px;">
					<tr>
						<!--<td align="center">
								<div class="titleTab" onclick="tabSelected(this,'titleTabTable','titleTab','titleTabSelected');changeTzType('gov');">
									政府投资
								</div>
						</td>
						<td align="right">
								<div class="titleTabSelected"  onclick="tabSelected(this,'titleTabTable','titleTab','titleTabSelected');changeTzType('enterprise');">
									企业投资
								</div>
						</td>
					--></tr>
						...
						<table style="width: 960px;" cellpadding="0px" cellspacing="0px" border="0px">
							...
							<tr>
								...
								<td valign="top" style="width: 956px;display:none" id="mainCount">
