			...
			<div class="BS_depm">
				...
				<s:if test="#request.pageView.totalRecord">
         			...
         			<s:else><tr class="even"></s:else>
							<td>
								<a href="javascript:findComplain('<s:property value="complainguid"/>','<s:property value="page"/>')" title="<s:property value="title"/>"><s:property value="title"/></a>
							</td>
							<td style="text-align: center">
								<s:property value="username"/>
							</td>
							<td style="text-align: center">
								<s:date name="complaindate" format="yyyy-MM-dd"/>
							</td>
							<td style="text-align: center">
								<s:if test="isresponse==0">
								未回复
								</s:if>
								<s:else>
								已回复
				...
				<tr>
	  				<td align="center" colspan="4" class="pageLinkTd">
