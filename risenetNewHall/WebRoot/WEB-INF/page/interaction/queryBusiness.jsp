...
<div class="GovOpenIndex ">
    <table border="0" cellpadding="0" cellspacing="0" style="width: 1000px; heigth: 100%" align="center">
		...
		<tr>
			<td align="left">
				<span style="font-size: 18pt;">进度查询</span>
			</td>
			<td align="right">
				&nbsp;
			</td>
			...
			<td style="text-align:left;padding:10px;" width="90%">
				<table id="userInfoTab" border="0" cellpadding="0" cellspacing="0" style="width: 90%">
					<tr>
						...
						<td >
							<s:textfield name="yxtywlsh" id="yxtywlsh" size="30" cssClass="zc_input02"></s:textfield>
					...
					<th >
						...
						<td >
							<s:select list="departList" onchange="searchBusi_stus('false',1)" listKey="code" listValue="value" headerKey="" headerValue="---请选择---" name="organizationCode" id="organizationCode" cssClass="zc_input02"></s:select>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td >
							<s:textfield name="cardId" id="cardId" size="30" cssClass="zc_input02"></s:textfield>
						</td>
					<th >
							申请人姓名：
						</th>
						<td >
							<s:textfield name="personName" size="30" id="personName" cssClass="zc_input02"></s:textfield>
						</td>
					...
					<tr>
						...
						<td >
							<s:textfield name="sqsj_S" id="sqsj_S" size="10" onclick="WdatePicker();" cssClass="zc_input02" readonly="true"></s:textfield>至
							<s:textfield name="sqsj_E"  id="sqsj_E" size="10" onclick="WdatePicker();" cssClass="zc_input02" readonly="true"></s:textfield>
						</td>
						<td>&nbsp;</td>
						<td>
							<input type="button" class="searchButton" value="查 询" onclick="searchBusi_stus('false',1)">
						</td>
					</tr>
