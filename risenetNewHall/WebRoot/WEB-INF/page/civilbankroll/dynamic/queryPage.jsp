...
function loadDivPage(){
	document.forms[0].action='/civilDynamic/resultPage.YS'
...
<div class="main">
<s:form action="/civilDynamic/queryPage.YS" method="post" id="queryFormId" target="queryIframe">
  ...
  <tr>
    <td width="100%" valign="top">
      ...
      <tr>
        ...
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="30%" style="text-align: left">民生创新==》实施中项目  </td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="right_table">
        ...
        <tr>
          <td class="resultTd" >
           <iframe id="queryIframe" name="queryIframe" onload="reinitIframe()" width="100%"  frameborder="0" scrolling="no" src="/civilDynamic/resultPage.YS">
           </iframe>
			</td>
          </tr>
	</table>
