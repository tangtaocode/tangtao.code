...
<div class="main">
<s:form action="/civilNotice/findNotice.YS" method="post">
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="table_index">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right_top">
      <tr>
        ...
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="30%" style="text-align: left">民生创新==通知公告==》详细信息 </td>
     ...
     <!-- 开始 -->
      <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="table_index">
  <tr>
    <td class="font_xxxx_title"><s:property value="civilNoticeBean.title"/>
    <hr width="100%" size="1" noshade /><center><font class="font_xx_right">发布时间：<s:property value="civilNoticeBean.starttime"/> </font></center></td>
  </tr>
  ...
  <tr>
    <td valign="top">
    	<table width="98%" border="0" cellpadding="0" cellspacing="0"  >
    		<tr>
    			<td width="2%">&nbsp;</td>
    			<td align="left"><s:property value="civilNoticeBean.content" escape="false"/> </td>
    			<td width="2%">&nbsp;</td>
    		</tr>
    	</table>
    </td>
