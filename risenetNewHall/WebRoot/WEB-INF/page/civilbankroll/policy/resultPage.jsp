...
<body>
<s:form action="/civilPolicy/resultPage.YS" method="post" id="queryFormId">
<s:hidden name="page"/>
<s:hidden name="title"/>
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="resultTableId">
         ...
         <td class="font_right_li_left02"><a href="/civilPolicy/findPolicy.YS?guid=<s:property value="id"/>" target="_blank">·
