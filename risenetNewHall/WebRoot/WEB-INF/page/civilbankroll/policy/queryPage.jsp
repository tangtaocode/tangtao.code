...
function loadDivPage(){
	document.forms[0].action='/civilPolicy/resultPage.YS'
...
<div class="main">
<s:form action="/civilPolicy/queryPage.YS" method="post" id="queryFormId" target="queryIframe">
  ...
  <tr>
    <td width="100%" valign="top">
      ...
      <tr>
        ...
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="30%" style="text-align: left">产业扶持==》扶持政策  </td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="right_table">
        ...
        <tr>
          <td class="resultTd" >
           <iframe id="queryIframe" name="queryIframe" onload="reinitIframe()" width="100%"  frameborder="0" scrolling="no" src="/civilPolicy/resultPage.YS">
           </iframe>
			</td>
          </tr>
	</table>
