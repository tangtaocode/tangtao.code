...
<html>
	...
	<body>
		<s:form action="/civilPublicity/saveComplain.YS" method="post"
			id="queryFormId">
			<s:hidden name="projectguid" id="projectguid"></s:hidden>
			<s:hidden name="civilComplainBean.complaintype" value="0"
				id="complaintype"></s:hidden>
						...
						<tr>
											...
											<td class="td_left" >
												<s:textfield name="civilComplainBean.username" id="username"
											...
											<td class="td_left" >
												<s:textfield name="civilComplainBean.telephone" id="telephone"
										...
										<tr>
											...
											<td class="td_left" >
												<s:textfield name="civilComplainBean.mobile" id="mobile" onkeyup="restrictNumber(this,'1',11)"
											...
											<td class="td_left" >
												<s:textfield name="civilComplainBean.email" id="email"
										...
										<tr>
											...
											<td colspan="3" class="td_left" >
												<s:textfield name="civilComplainBean.title" id="title"
										...
										<tr>
											...
											<td colspan="3" class="td_left" >
												<s:textarea name="civilComplainBean.content" id="content"
