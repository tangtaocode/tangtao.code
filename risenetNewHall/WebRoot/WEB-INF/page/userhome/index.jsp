...
<div class="GovOpenIndex ">
	...
	<table border="0" cellpadding="0" cellspacing="20px" style="width: 100%;">
		<tr>
			<td align="left">
				<span style="font-size: 18pt;">办事跟踪</span>
			</td>
			<td align="right">
				&nbsp;
			</td>
							...
							<tr>
								...
								<td valign="top" style="width:956px;" >
									<div id="menuDiv" style="float:left">
										...
										<ul>
										<li><a href="javascript:busiFlow();">审批业务跟踪</a></li>
										<li><a href="javascript:editUser('approveItem')">用户基础信息</a></li>
										<li><a href="javascript:changePwd()">修改密码</a></li>
										<li><a href="/user/logoutAction.html">退出系统</a></li>
										</ul>
										</div>
									</div>
									<div id="stepPageCount" style="width:795px;float:right">
										<jsp:include page="/WEB-INF/page/userhome/busiResult.jsp"></jsp:include>
									</div>
								 </td>
