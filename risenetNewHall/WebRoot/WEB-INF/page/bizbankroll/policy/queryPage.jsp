...
<script type="text/javascript">
	function searchLaw(pageNum){
		$.post("/bizNotice/resultPage.html",{title:$("#title").val(),page:pageNum,ntype:'1'},function(data){
			$("#resultDiv").html(data);
		});
	}
...
<jsp:param name="menu" value="2"/>
   ...
   <!-- 查询 -->
    <table border="0" cellpadding="0" cellspacing="15px" style="width: 98%;">
		<tr>
			<td align="left">
				<span style="font-size: 18pt;">扶持政策</span>
			</td>
			<td align="right">
				&nbsp;
			</td>
       ...
       <div class="more_domiddlein">
       	<table id="userInfoTab" border="0" cellpadding="0" cellspacing="0" style="width: 90%">
	       	<tr>
				...
				<td><input type="button" class="searchButton" value="查 询" onclick="searchLaw('')"></td>
			</tr>
       	</table>
       	
		<div id="resultDiv" >
			<jsp:include page="/WEB-INF/page/bizbankroll/policy/resultPage.jsp"></jsp:include>
		</div>
       	</div>
