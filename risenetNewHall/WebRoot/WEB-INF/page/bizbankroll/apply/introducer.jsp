  ...
  <tr>
      ...
      <tr><td >
         ...
         <TR>
			...
			<s:hidden name="introducerBean.category_id" id="category_id"></s:hidden>
        	<s:hidden name="introducerBean.category" id="category"></s:hidden>
			<s:hidden name="introducerBean.provision" id="provision"></s:hidden>
			<s:hidden name="introducerBean.state" id="state" value="1"></s:hidden>
			<s:hidden name="introducerBean.xmlxroot" id="xmlxroot"></s:hidden>
			<s:hidden name="introducerBean.guid" id="guid"></s:hidden>
			<s:hidden name="introducerBean.zgbmid" id="zgbmid"></s:hidden>
			<s:hidden name="introducerBean.yjrno" id="yjrno"></s:hidden>
			申请资助类别：</TD>
