		...
		<div id="footer" width=698>
			<TABLE id=maintable align=center width=698>
			  ...
			  <TR>
			    <TD align=middle>
			      <HR 
			      style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; HEIGHT: 8px; BORDER-TOP: #000000 10px groove; BORDER-RIGHT: medium none">
			    </TD>
			  </TR>
			  <TR>
			    <TD  align=middle>
			      <TABLE border=0 cellPadding=0 width=698>
			        ...
			        <TR>
			          <TD style="TEXT-ALIGN: left"><span 
			            style="FONT-SIZE: 14px">龙岗建设网网址：www.cb.gov.cn</span></TD>
			          <TD style="TEXT-ALIGN: right"><span 
			            style="FONT-SIZE: 14px">咨询电话：28589110</span></TD>
			          </TR>
			         </TBODY>
			       </TABLE>
			      </TD>
