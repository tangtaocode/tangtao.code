...
<html>
  ...
  function changeType(){
  	changeOrder('orderCode','depart');
  	searchAppByDepart($("#departGUID").val(),$("#departGUID option:selected").text());
  }
  function topage(page){
	searchAppByDepart($("#departGUID").val(),$("#departGUID option:selected").text(),page);
  }
  ...
  <s:hidden name="method" value="departBack"></s:hidden>
  ...
  <div class="BS_domiddlein">
			...
			<div class="BS_depm">
				...
				<div class="BS_title2">
					<span class="BS_titletxt"><s:property value="departmentName"/></span>
				</div> 
				...
				<div class="BS_doheader noborder" style="text-align:right;font-size:16px;">
					部门：<s:select cssClass="loginInput" listKey="code" listValue="value" list="departMap" onchange="changeType()" name="departGUID" id="departGUID"  headerKey="" headerValue="---请选择---" value="departGUID"></s:select> 
					&nbsp;&nbsp;
			...
			<a id="searchLink" href="javascript:changeType()"><img src="/images/govpublic/tb_see_right.gif" style="border:0px;vertical-align: middle" /> </a>
				...
				<!--搜索结果 start-->
					<table cellpadding="0" cellspacing="0" border="0" width="100%"
						...
						<tr>
							<th width="50%">
								<a href="javascript:changeOrder('itemName','depart');">服务事项名称</a>
							...
							<th>
								<a href="javascript:changeOrder('departName','depart');">主管部门</a>
