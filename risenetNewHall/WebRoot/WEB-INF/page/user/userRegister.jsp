...
<div class="GovOpenIndex ">
	...
	<table border="0" cellpadding="0" cellspacing="20px" style="width: 100%;">
		<tr>
			<td align="left">
				<span style="font-size: 18pt;">用户注册</span>
			</td>
			<td align="right">
				&nbsp;
			</td>
						...
						<table style="width: 960px;" cellpadding="0px" cellspacing="0px" border="0px">
							...
							<tr>
								...
								<td valign="top" style="width:956px;" >
									...
									<jsp:include page="/WEB-INF/page/user/baseInfo.jsp"></jsp:include>
									</s:if>
									<s:if test="#session.loginUser!=null">
									<s:if test="#session.loginUser.usertype==1">
										<jsp:include page="/WEB-INF/page/user/addPersonal.jsp"></jsp:include>
									</s:if>
									<s:if test="#session.loginUser.usertype==2||#session.loginUser.usertype==3">
										<jsp:include page="/WEB-INF/page/user/addCompanyInfo.jsp"></jsp:include>
									</s:if>
									<s:if test="#session.loginUser.usertype==4||#session.loginUser.usertype==5||#session.loginUser.usertype==6">
										<jsp:include page="/WEB-INF/page/user/addOrganizational.jsp"></jsp:include>
									</s:if>
									</s:if>
								</td>
