...
(function() {
	...
	Dialog.prototype.setPosition = function() {
		...
		if (typeof this.Top == "string" && this.Top.indexOf("%") != -1) {
			...
			//thisTop = bd.scrollTop+(thisdialogDiv.scrollHeight/2-100);
		}
	...
	Dialog.confirmtip = function(diag,msg, funcOK, funcCal) {
		diag.ShowButtonRow = true; 
		diag.CancelEvent = function() {
			diag.close();
			if (funcCal) {
		...
		diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0" >' + '		<tr>' + '			<td align="center" id="Message_' + this.ID + '" style="font-size:11pt">' + msg + '</td></tr>' + '	</table>';
		diag.show();
		diag.okButton.parentNode.style.textAlign = "center";
		diag.okButton.focus();
		diag.hiddenCloseButton();
	};
	Dialog.maxConfirm = function(msg, funcOK, funcCal, w, h){
		w = w || 400;
		h = h || 210;
		var diag = new Dialog({
			Width: w,
