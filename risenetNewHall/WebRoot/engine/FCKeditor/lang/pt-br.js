...
lang["Save"]				= "Salvar" ;
lang["Zoom"]				= "Zoom" ;
lang["SpellCheck"]			= "Correção Ortográfica" ;

lang["FontStyle"]			= "Estilo" ;
lang["FontFormat"]			= "Formato" ;
lang["Font"]				= "Fonte" ;
lang["FontSize"]			= "Tamanho" ;
lang["FontStyleAdv"]		= "Estilo de Fonte Avançado" ;
...
lang["Button"]				= "Botão" ;
lang["SelectionField"]		= "Campo de Seleção" ;
lang["ImageButton"]			= "Botão Imagem" ;
...
lang["TableAutoFormat"]		= "Auto-formatação da Tabela" ;
lang["ImageProperties"]		= "Propriedades da Imagem" ;
lang["AnchorProperties"]	= "Propriedades da Ancora" ;
lang["ButtonProperties"]	= "Propriedades do Botão" ;
...
lang["ImageButtonProperties"]	= "Propriedades do Botão Imagem" ;
lang["FieldProperties"]			= "Propriedades do Campo" ;
lang["SelectionFieldProperties"]= "Propriedades do Campo de Seleção" ;
...
lang["NoSpellCheck"]		= "A correção ortográfica não pode ser executada." ;
lang["DownloadSpellChecker"]= "Corretor ortográfico não instalado. Quer fazer o download agora?" ;
lang["SpellCheckFinished"]	= "Fim da correção ortográfica." ;
...
lang["DlgReplaceCaseChk"]	= "Não ignorar Maiusc./Minusc." ;
...
lang["DlgFormAction"]	= "Ação" ;
lang["DlgFormMethod"]	= "Método" ;

// Select Field Dialog
lang["DlgSelectName"]		= "Nome" ;
lang["DlgSelectValue"]		= "Valor" ;
lang["DlgSelectSize"]		= "Dimensão" ;
lang["DlgSelectLines"]		= "linhas" ;
lang["DlgSelectChkMulti"]	= "Ativa seleção múltipla" ;
lang["DlgSelectOpAvail"]	= "Opções Disponíveis" ;
...
lang["DlgAutoFormatWindowTitle"]	= "Auto-formatação da Tabela" ;
lang["DlgAutoFormatTableStyle"]		= "Estilo da Tabela:" ;
lang["DlgAutoFormatTableAlert"]		= "Seleciona um estilo e aperta o botão \"OK\". Atenção: toda a formatação atual da tabela será removida!" ;

// Bulleted List Dialog
lang["DlgLstWindowTitle"]	= "Propriedades dos Marcadores" ;
lang["DlgLstType"]			= "Tipo" ;
lang["DlgLstTypeNotSet"]	= "<Não selecionado>" ;
