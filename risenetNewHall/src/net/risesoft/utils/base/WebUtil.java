...
public class WebUtil {
	public static UserInfo getUserInfo(HttpServletRequest request){
		return (UserInfo) request.getSession().getAttribute(Common.sessionLoginUserID);
	}
    /***
	 ...
	 * @return
	 */
	public static String nobrtr(String value) {
		  if (value == null)
		   return ("");
		  value = value.replaceAll("\n\r","");
	...
	public static String strToParam(String str,String splistType){
		if(StringUtils.isBlank(str)){
			return "''";
		}else{
			String[] param = str.split(splistType);
			String params = "";
